...
fun kthPerfectSquare(a: Int): Int  { //returns the sqauare of argument plus one
    return (a + 1) * (a + 1)
}
...
fun perfectDescription(a: Int) {         //prints text describing the given perf. sqr. using the fun. above
    //val descript = "perfect square " + a + " is " + kthPerfectSquare(a)
...
fun main() { //main fun. to test outputs
    //outputs inputs/outputs/expectations for kthPerfectSquare
    fun testSquare(k: Int, expectedResult: Int) {   //tests above functions and returns their values compared to expected values
